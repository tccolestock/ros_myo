...
if __name__ == '__main__':
    ...
    # Define Publishers
    imuPub = rospy.Publisher('myo_imu_right', Imu, queue_size=10)
    emgPub = rospy.Publisher('myo_emg_right', EmgArray, queue_size=10)
    armPub = rospy.Publisher('myo_arm_right', MyoArm, queue_size=10)
    gestPub = rospy.Publisher('myo_gest_right', UInt8, queue_size=10)

    orienPub=rospy.Publisher('myo_orien_right', Vector3, queue_size=10)
    # posPub=rospy.Publisher('myo_pos', Vector3, queue_size=10)

    rospy.init_node('myo_raw_right', anonymous=True)
