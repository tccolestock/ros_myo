...
""" myo_emg_parse.py: Collects the MyoBand electrode data and parses it into flexion, extension, and diff (flextion-extension) values for publishing on separate rostopics. """
